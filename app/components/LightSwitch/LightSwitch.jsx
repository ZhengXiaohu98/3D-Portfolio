const LightSwitch = ({ switchState, setSwitch, isViewing }) => {
  ...
  return (
    <div className={`fixed md:left-1/2 md:bottom-[5vh] md:-translate-x-1/2 sm:left-[10vw] sm:bottom-[5vh] flex flex-col items-center gap-[10px] transition duration-300 ${isViewing ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}>
